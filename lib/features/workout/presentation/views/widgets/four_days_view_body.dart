...
class FourDaysViewBody extends StatelessWidget {
  const FourDaysViewBody({super.key});
          ...
          child: Column(
            children: [
              ...
              CustomWorkoutCard(
                ...
                subtitle: 'Day 1',
                imagePath: 'assets/images/chest and triceps.png',
              ...
              CustomWorkoutCard(
                ...
                subtitle: 'Day 2',
                imagePath: 'assets/images/back and bicebs.png',
                onStart: () {},
              ),
              SizedBox(height: height * 0.03),
              CustomWorkoutCard(
                title: 'Shoulder and Trapezius',
                subtitle: 'Day 3',
                imagePath: 'assets/images/shoulder and trapzeius.png',
                onStart: () {},
              ),
              SizedBox(height: height * 0.03),
              CustomWorkoutCard(
